...
function NewSection(){
    ...
    return(
        ...
        <section id="new-sec">
        <h2 className="new-sec-header">New Section</h2>
        <hr style={{ marginTop: 0 , marginBottom: '1vh' ,width:'60%', background:'black'}} />
        <Grid ref={Ref2} container spacing={2}>
            <Grid item xs={12} md={3}>
                <Card  className={`${"castello-card1 hidden "}${inView ? " show-new":""}`} sx={{ maxWidth: '100%' }}>
                <CardMedia
                    sx={{ height: 200 }}
                ...
                <Grid item xs={12} md={3}>
                <Card className={`${"castello-card2 hidden "}${inView ? " show-new":""}`} sx={{ maxWidth: '100%' }}>
                <CardMedia
                    sx={{ height: 200 }}
                    image="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/115250--01--1555690663.jpeg"
                    title="Whole Peeled Tomato"
            ...
            <Grid item xs={12} md={3}>
                <Card className={`${"castello-card3 hidden "}${inView ? " show-new":""}`}  sx={{ maxWidth: '100%' }}>
                <CardMedia
                    sx={{ height: 200 }}
                    image="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/115250--01--1555690663.jpeg"
                    title="Whole Peeled Tomato"
                ...
                <Grid item xs={12} md={3}>
                <Card className={`${"castello-card4 hidden "}${inView ? " show-new":""}`}  sx={{ maxWidth: '100%' }}>
                <CardMedia
                    sx={{ height: 200 }}
                    image="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/115250--01--1555690663.jpeg"
                    title="Whole Peeled Tomato"
